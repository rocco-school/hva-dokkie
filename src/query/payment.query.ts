export const PAYMENT_QUERY: {
    ...
    CREATE_PAYMENT: "INSERT INTO payment (datePaid, description, paymentAmount, eventId, participantId, expenseId) VALUES(?, ?, ?, ?, ?, ?)",
